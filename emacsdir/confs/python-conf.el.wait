...
(defun elpy-mode-setup-hook ()
  ...
  (activate-yasnippet-buffer-local-with-dirs (list (expand-file-name "snippets" (file-name-directory ech-emacs-d-dir)) (concat (file-name-directory (locate-library "elpy")) "snippets/")))
