...
(require 'autoload)
(jde-make-autoloads-and-compile (expand-file-name "C:\MyHome\dev\emacsdir\site-lisp\jdee\build\lisp")
				"C:\MyHome\dev\emacsdir\site-lisp\jdee\lisp"
				"c:\MyHome\dev\emacsdir\site-lisp\cedet"
				'("common"
				  "eieio"
				  "semantic"
				  "semantic/bovine"
