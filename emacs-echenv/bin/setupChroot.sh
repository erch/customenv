...
PACK_DIR=/var/chroot/var/cache/echenv-emacs
if [ -e "$PACK_DIR" ] ; then
    rm -rf ${PACK_DIR}/*
else
    mkdir -p $PACK_DIR
fi
cp -R ${MY_DIR}/../debian/var/cache/echenv-emacs/* ${PACK_DIR}
mountonce ${MY_DIR}/../debian /var/chroot/var/packaging/echenv-emacs
