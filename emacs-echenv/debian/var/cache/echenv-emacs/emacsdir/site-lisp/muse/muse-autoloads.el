...
;;; Code:

;;;### (autoloads nil "muse" "muse.el" (18803 38886))
...
(autoload (quote muse-import-latex) "muse-import-latex" nil t nil)
...
Turn the proper Emacs Muse related mode on for this file." nil nil)

(autoload (quote muse-insert-list-item) "muse-mode" "\
Insert a list item at the current point, taking into account
your current list type and indentation level." t nil)

(autoload (quote muse-increase-list-item-indentation) "muse-mode" "\
Increase the indentation of the current list item." t nil)

(autoload (quote muse-decrease-list-item-indentation) "muse-mode" "\
Decrease the indentation of the current list item." t nil)

(autoload (quote muse-insert-relative-link-to-file) "muse-mode" "\
Insert a relative link to a file, with optional description, at point." t nil)
...
using the specified command." t nil)

(autoload (quote muse-search) "muse-mode" "\
Search for the given TEXT using the default grep command." t nil)

(autoload (quote muse-find-backlinks) "muse-mode" "\
Grep for the current pagename in all the project directories." t nil)
...
(autoload (quote muse-list-edit-minor-mode) "muse-mode" "\
...
\\{muse-list-edit-minor-mode-map}" t nil)
...
;;;;;;  "muse-publish" "muse-publish.el" (18803 38886))
...
The result is placed in a new buffer that includes TITLE in its name." t nil)
